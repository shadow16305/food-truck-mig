...
const Hamburger = ({ isOpen, setIsOpen }: HamburgerProps) => {
  ...
  return (
    <button
      ...
      <div className={cn(hamburgerLine, isOpen && "origin-center rotate-45 translate-y-2")} />
      <div className={cn(hamburgerLine, isOpen && "opacity-0")} />
      <div className={cn(hamburgerLine, isOpen && "origin-center -translate-y-3 -rotate-45")} />
    </button>
  );
};
